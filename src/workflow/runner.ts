...
import type { WorkflowStateStore } from "./persistence.js";
import { getNextStep } from "./transitions.js";

const retryPolicies: Partial<Record<WorkflowStep, { maxAttempts: number; baseDelayMs: number }>> = {
...
function record(state: WorkflowState, step: WorkflowStep, status: "running" | "success" | "failed", attempt: number, error?: string): void {
