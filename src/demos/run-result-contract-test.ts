...
assertStopped(toAgentRunResult(new AgentRunBudgetExceededError("steps", 8, 9)), "max_steps_reached", 200);
assertStopped(toAgentRunResult(new AgentRunBudgetExceededError("model_calls", 12, 13)), "budget_exceeded", 200);
assertStopped(toAgentRunResult(new TimeoutError(5000)), "deadline_exceeded", 504);
